...
class Xception(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        x3 = self._layers[2]._blocks[0](x2)
...
def xception_65(num_classes=None,
                ...
                scope='xception_65',
                pretrained=True,
                checkpoint_path='E:/Anaconda3/Project/pytorch1.1_segmentation/pretrained/xception_65.pth'):
    """Xception-65 model."""
    xception = Xception65(num_classes=num_classes, global_pool=global_pool, 
                          keep_prob=keep_prob, output_stride=output_stride,
                          scope=scope)
    if pretrained:
        _load_state_dict(xception, num_classes, checkpoint_path='E:/Anaconda3/Project/pytorch1.1_segmentation/pretrained/xception_65.pth')
    return xception
